      ...
      <div>
        <div className="text-center ">
          ...
          <p className="py-4 lg:text-lg font-outfits w-full lg:w-[60%] mx-auto">
            Join our servicing subscription plans and keep your bicycle
            performing like new throughout the year.
          </p>
        </div>

        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 p-10 lg:p-20">
          <div className=" bg-transparent rounded-2xl hover:shadow-info cursor-pointer duration-300 transition-all  shadow-xl shadow-accent p-6">
            <div className="text-center">
              ...
              <p className="text-4xl py-4 font-extrabold text-success">
                $9/month
              </p>
            </div>
